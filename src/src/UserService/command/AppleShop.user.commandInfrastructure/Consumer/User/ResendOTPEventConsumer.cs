...
{
    public class ResendOTPEventConsumer : IConsumer<ResendOTPEvent>
    {
        private readonly IUserRepository userRepository;
        private readonly IEmailService emailService;

        public ResendOTPEventConsumer(IUserRepository userRepository, IEmailService emailService)
        {
            this.userRepository = userRepository;
            this.emailService = emailService;
        }

        public async Task Consume(ConsumeContext<ResendOTPEvent> context)
        {
