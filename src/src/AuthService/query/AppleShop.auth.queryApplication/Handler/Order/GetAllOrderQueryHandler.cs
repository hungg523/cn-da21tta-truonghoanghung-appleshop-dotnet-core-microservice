...
namespace AppleShop.auth.queryApplication.Handler.Order
{
    public class GetAllOrderQueryHandler : IRequestHandler<GetAllOrderQuery, Result<List<OrderFullDTO>>>
    {
        ...
        public GetAllOrderQueryHandler(IAuthRepository orderRepository, IRequestClient<GetAllCartItemByUserIdEvent> requestClient, IOrderItemRepository orderItemRepository)
        {
