...
using AppleShop.promotion.Domain.Abstractions.IRepositories.Base;
using AppleShop.promotion.Persistence.Repositories;
...
namespace AppleShop.promotion.Persistence.DependencyInjection.Extensions
{
